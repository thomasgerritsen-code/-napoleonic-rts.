...
test('Village landscape v7 adds archetype character without changing navigation authority', async ({ page }) => {
  const errors=[];
  ...
  expect(result.landscape.version).toBe('village-landscape-v7');
