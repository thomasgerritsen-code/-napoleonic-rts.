...
const formationFacingV146BridgeScript=document.createElement('script');formationFacingV146BridgeScript.src='src/foundation/formation-facing-v146-bridge.js?build=146b';formationFacingV146BridgeScript.async=false;document.body.appendChild(formationFacingV146BridgeScript);
const tacticalHudV147Script=document.createElement('script');tacticalHudV147Script.src='src/systems/ui/tactical-hud-v147.js?build=147a';tacticalHudV147Script.async=false;document.body.appendChild(tacticalHudV147Script);
const tacticalHudV148Script=document.createElement('script');tacticalHudV148Script.src='src/systems/ui/tactical-hud-v148.js?build=148a';tacticalHudV148Script.async=false;document.body.appendChild(tacticalHudV148Script);
const tacticalHudV149Script=document.createElement('script');tacticalHudV149Script.src='src/systems/ui/tactical-hud-v149.js?build=149a';tacticalHudV149Script.async=false;document.body.appendChild(tacticalHudV149Script);
const visualFoundationV2Script=document.createElement('script');visualFoundationV2Script.src='src/systems/rendering/visual-foundation-v2.js?build=vf2a';visualFoundationV2Script.async=false;document.body.appendChild(visualFoundationV2Script);
